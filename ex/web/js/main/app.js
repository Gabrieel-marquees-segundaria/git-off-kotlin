import { files, sidebarItems, contentHeaders } from "./data.js";
...
function filterFilesByCategory(category) {
    ...
    switch (category) {
        case "documents":
            filteredFiles = files.filter(file =>
                ["pdf", "document", "spreadsheet", "presentation"].includes(
                    file.type
                )
            );
            break;
    ...
    renderFiles(filteredFiles, formatDate);

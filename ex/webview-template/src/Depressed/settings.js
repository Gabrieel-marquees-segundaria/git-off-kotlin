...
class FloatingMenu {
    ...
    addMenuItems() {
        ...
        menuItems.forEach((item, index) => {
            ...
            // Estilos para cada item do menu - com espaçamento menor
            Object.assign(menuItem.style, {
                ...
                borderRadius: "12px",
                marginBottom: "4px", // Reduzido de 8px para 4px
                cursor: "pointer",
            ...
            menuItem.addEventListener("mouseleave", () => {
                ...
                if (this.isOpen) {
                    // Reduzido de 80px para 50px para ficar mais próximo
    ...
    openMenu() {
        ...
        // Animate menu items - com espaçamento menor
